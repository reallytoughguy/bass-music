...
a8 = Album.create(cover: "https://images-na.ssl-images-amazon.com/images/I/61vAHV2ptZL._SS500_PIPJStripe-Robin-Large-V2,TopLeft,0,0.jpg", title: "Ten", artist: "PearlJam")
Track.create(name: "Once", minutes: 3, album_id: a8.id)
Track.create(name: "Even Flow", minutes: 4, album_id: a8.id)
Track.create(name: "Alive", minutes: 5, album_id: a8.id)